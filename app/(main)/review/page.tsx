    ...
    return (
      <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center">
        <div className="text-center">
          <div className="w-12 h-12 border-4 border-violet-200 dark:border-violet-900 border-t-violet-600 dark:border-t-violet-400 rounded-full animate-spin mx-auto mb-4" />
      ...
      <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4">
        <div className="w-full max-w-md text-center">
          ...
          <div className="space-y-3">
            <Link
              href="/dashboard"
              className="block w-full py-3 px-6 bg-violet-600 hover:bg-violet-700 text-white font-semibold rounded-xl transition-colors text-center"
            >
              {t('backToDashboard')}
            </Link>
            <button
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        {/* Estimated time */}
        <div className="bg-gray-50 dark:bg-gray-800/50 rounded-[22px] shadow-card p-4 mb-8 flex items-center justify-center gap-2">
