          ...
          >
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between rounded-xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800/50">
                <div>
                  <h4 className="font-medium text-gray-900 dark:text-white">Reset Onboarding</h4>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Start fresh with the welcome tutorial</p>
                </div>
                <button
