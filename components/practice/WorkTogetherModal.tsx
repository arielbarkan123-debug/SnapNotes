...
import ExplanationStyleSelector from '@/components/homework/ExplanationStyleSelector'
...
export default function WorkTogetherModal({
    ...
    try {
      const response = await fetch('/api/practice/tutor', {
        ...
        body: JSON.stringify({
          ...
          language: locale,
          enableDiagrams: visualPrefs.diagramMode !== 'off',
          diagramMode: visualPrefs.diagramMode,
          explanationStyle,
        }),
      })
  ...
  }, [isLoading, sessionId, question, userAnswer, wasCorrect, conversation, locale, isRTL, retryCount, explanationStyle, visualPrefs.autoGenerateDiagrams])
  ...
  }, [isLoading, sessionId, question, conversation, locale, explanationStyle, visualPrefs.autoGenerateDiagrams])
