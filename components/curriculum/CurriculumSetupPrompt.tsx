...
export function CurriculumSetupPrompt({
  ...
  return (
    <div
      className={cn(
        'relative rounded-lg border border-violet-200 dark:border-violet-800 bg-violet-50 dark:bg-violet-900/20 p-4',
        className
      )}
    >
      {dismissible && (
      ...
      <div className="flex items-start gap-3">
        <div className="flex-shrink-0 w-10 h-10 rounded-full bg-violet-100 dark:bg-violet-800 flex items-center justify-center">
