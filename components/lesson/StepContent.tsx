...
function SummaryStep({ content, lessonTitle, t }: SummaryStepProps) {
  ...
  return (
    <div className="animate-fadeIn">
      <div className="bg-gradient-to-br from-violet-50 to-purple-50 dark:from-violet-900/20 dark:to-purple-900/20 border border-violet-200 dark:border-violet-800 rounded-2xl p-6">
