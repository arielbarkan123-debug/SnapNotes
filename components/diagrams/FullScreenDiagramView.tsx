  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* CSS overrides: remove per-component maxWidth caps so diagrams
               use the full container width. Components already receive large
               width/height props from containerSize. */}
          <div
